...
// InitBulkReply creates  BulkReply
func InitBulkReply(arg []byte) *BulkReply {
	return &BulkReply{
		Arg: arg,
	}
}
...
// InitMultiBulkReply creates MultiBulkReply
func InitMultiBulkReply(args [][]byte) *MultiBulkReply {
...
// InitMultiRawReply creates MultiRawReply
func InitMultiRawReply(replies []redis.Reply) *MultiRawReply {
...
// InitStatusReply creates StatusReply
func InitStatusReply(status string) *StatusReply {
	return &StatusReply{
		Status: status,
	}
}
...
// InitIntReply creates int protocol
func InitIntReply(code int64) *IntReply {
	return &IntReply{
		Code: code,
	}
}
...
// InitErrReply creates StandardErrReply
func InitErrReply(status string) *StandardErrReply {
